...
class FCNDecoder(nn.Module):
    def __init__(self, decode_layers, decode_channels=[], decode_last_stride=8, DEVICE = 'cuda:0'):
        ...
        self._conv_final = nn.Conv2d(self._out_channel, 3, kernel_size=1, bias=False)
